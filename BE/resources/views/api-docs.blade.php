...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .chip.PUT, .chip.PATCH { background: var(--chip-put); }
        .chip.DELETE { background: var(--chip-delete); }
        ...
        .btn-reset { background: #e4d7cb; color: var(--ink); }
        ...
        @media (max-width: 1040px) {
            ...
            .endpoint-list { max-height: 300px; }
        }
...
<div class="page">
    <section class="hero">
        ...
        <p>Dùng như Postman mini trên web: chọn endpoint, sửa JSON body/header, gửi request và xem phản hồi ngay.</p>
    </section>
